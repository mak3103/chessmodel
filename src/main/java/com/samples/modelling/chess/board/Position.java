...
public class Position {
	 ...
	 * @return - A path style that is applicable when a piece moves from aStart to aEnd.
	 */
	...
	/**
	 * Returns the no of blocks travelled by the piece if it goes from aStart to aEnd.
	 * @param aStart - the starting position
	 * @param aEnd - the final position of the piece.
	...
	public static int getDisplacement(Position aStart, Position aEnd) {
		...
		switch(pathStyle)
		{
			case STRAIGHT : if(aStart.getxIndex()==aEnd.getxIndex())
			{
